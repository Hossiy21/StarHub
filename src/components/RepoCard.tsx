                    ...
                    <div className="space-y-6 pt-6 border-t border-border/10 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-100 transition-all duration-300 font-bold text-[12px] shadow-lg shadow-slate-900/10 dark:shadow-white/5 group/btn w-fit border border-slate-800 dark:border-white/10"
                            >
